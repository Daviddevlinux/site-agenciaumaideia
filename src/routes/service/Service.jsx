...
const Service = () => {
  return (
    <div>
      <Hero cName="hero mid" heroImg={serviceImg} title="Serviços" />
      ...
      <div className="service-container">
        ...
        <div className="plan-container">
          <h2>Nossos Planos</h2>
          <p>Oferecemos os melhores planos para as necessidades do cliente</p>

          <div className="plan-card-container">
            {plansData.slice(0, 4).map((plan, index) => (
              <PlanCard key={index} title={plan.title} details={plan.details} />
            ))}
          </div>
